# SQL Challenge (Module #9 Assignment)
### Jonathan Carmichael (8/30/2023)
...
Download the starting files [here](https://static.bc-edx.com/data/dl-1-2/m9/lms/starter/Starter_Code.zip).
